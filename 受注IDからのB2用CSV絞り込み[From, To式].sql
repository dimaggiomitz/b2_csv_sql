...
NULL AS '収納代行品名',
NULL AS '収納代行備考',
(case when CHARACTER_LENGTH(GENZAI_EIGYOSYO_NM)  0 then concat(GENZAI_SITEN_NM,'',GENZAI_EIGYOSYO_NM) else GENZAI_SITEN_NM end) AS '支店営業所',
...
AND dtb_order.order_id = 5400
AND dtb_order.order_id = 5700
